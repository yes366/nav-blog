...
**Best for**: Prose generation, scene expansion, style matching
**Price**: Subscription-based, starts at $10/month
...
**Best for**: Novel writing, long-form storytelling, style customization
**Price**: Subscription tiers available
...
**Best for**: World-building, lore generation, setting consistency
...
**Best for**: Screenplays, dramatic structure, dialogue
**Price**: Free (research project)
...
**Best for**: Book marketing, blurbs, social media content
...
**Planning phase**: ChatGPT/Claude for brainstorming, World Anvil for world-building structure
**Character development**: Naviya for dialogue testing and character interviews
**Drafting**: NovelAI or Sudowrite for scene expansion when I'm stuck
**Revision**: Claude for consistency checking, Naviya for re-testing character voice after revisions
**Marketing**: Jasper for book descriptions and social media
